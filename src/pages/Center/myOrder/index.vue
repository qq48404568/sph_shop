 ...
 * @Description: 
 * @Author: RyangXie
 * @Date: 2021-12-30 14:38:47
 * @LastEditTime: 2021-12-30 21:01:32
          ...
          <tbody>
            <tr v-for="(cart,index) in order.orderDetailList"
              ...
              <td width="60%">
                <div class="typographic">
                  <img :src="cart.imgUrl"
                       ...
                       height="100px">
                  <a href="#"
                     class="block-text">{{cart.skuName}}</a>
              ...
              <td :rowspan="order.orderDetailList.length"
                  v-if="index==0"
                  width="8%"
                  class="center">{{order.consignee}}</td>
              <td :rowspan="order.orderDetailList.length"
                  v-if="index==0"
                  width="13%"
                  class="center">
              ...
              <td :rowspan="order.orderDetailList.length"
                  ...
                  class="center">
                <a href="#"
                   class="btn">{{order.orderStatusName}} </a>
              </td>
              <td :rowspan="order.orderDetailList.length"
                  v-if="index==0"
                  width="13%"
...
export default {
  ...
  methods: {
    async getData () {
      ...
      let result = await this.$API.redMyOrderList(page, limit)
      if (result.code == 200) {
